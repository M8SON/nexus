...
Shared agent-agnostic policies that any nexus-aware assistant should follow when working under `/home/daedalus/linux`. These are a **core feature** of nexus — adapters point at them rather than inlining their own rules.
